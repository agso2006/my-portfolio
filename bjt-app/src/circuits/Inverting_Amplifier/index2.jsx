...
export default function Inverting_Amplifierr (props) {   
  ...
  useEffect(() => {  
    ...
    var bool = true
    var x = outcomes.Vout
    //αν το vout βγει εκτός ορίων τότε το bool γίνεται false (θα χρειαστεί για το blink) και το x η ελάχιστη επιτρεπτή τιμή που θα σταλεί για τα γραφήματα
      ...
      <Card className='mx-auto'>
        <Card.Body>
          <Row className='mb-3'>
            ...
            <Col xs={3}>
              <img style={{ width: '240%', height: '80%'}} src={circuitImg} alt='' />
            </Col> 
          ...
          <Row> <Col style={{ textAlign: 'center' }}>Αναστρέφων ενισχυτής </Col> </Row>
...
Inverting_Amplifierr.image = circuitImg 